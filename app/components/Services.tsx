...
import vocation from '../assets/vocation.svg'
import pedagogy from '../assets/pedagogy.svg'
import test from '../assets/testVocational.svg'
    ...
    <div className="pt-20">
      ...
      >
        {slideServices.map((data)=>(
          <SwiperSlide key={data.id} className='flex flex-col justify-between border border-black rounded-lg ps-5'>
              <img className='rounded-lg' src={data.image} alt={data.title} />
              <div className='h-60 w-5/6'>
